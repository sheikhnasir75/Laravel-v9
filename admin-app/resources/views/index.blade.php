...
<head>
    <meta charset="utf-8">
    <title>{{ $staffprofile->title }}</title>
...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="51">
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light fixed-top shadow py-lg-0 px-4 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        <a href="index.html" class="navbar-brand d-block d-lg-none">
            <h1 class="text-primary fw-bold m-0">Some data</h1>
        </a>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 py-6 pb-0 pt-lg-0">
                    ...
                    <h1 class="display-3 mb-3">{{ $staffprofile->staffname }}</h1>
                    <h2 class="typed-text-output d-inline"></h2>
                    <div class="typed-text d-none">{{ $staffprofile->Jobs }}</div>
                    <div class="d-flex align-items-center pt-5">
                        <a href="" class="btn btn-primary py-3 px-4 me-5">Download CV</a>
                        <button type="button" class="btn-play" data-bs-toggle="modal"
                            data-src="{{ $staffprofile->youtube }} data-bs-target="#videoModal">
                            <span></span>
                        </button>
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="{{ $staffprofile->profilepic }}" alt="">
                </div>
            </div>
        </div>
    </div>
